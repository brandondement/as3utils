package bdement.ui.lists
{
	...
	import bdement.ui.containers.VGroup;
	import bdement.ui.effects.ListPageEffect;
	import flash.display.DisplayObject;

	[DefaultProperty("data")]
	public final class VList extends VGroup implements IList
	{
		...
		public function VList(itemRenderer:Class = null, data:* = null, gap:Number = 10)
		{
			super(gap);
